      ...
      <div style={{ marginLeft:220 }}>
        <div style={{ height:56, background:'#fff', borderBottom:'1px solid rgba(0,0,0,0.08)', display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 28px', position:'sticky', top:0, zIndex:50 }}>
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            ...
            {!cargando && <span style={{ fontSize:11, padding:'2px 8px', borderRadius:999, background:'#E1F5EE', color:'#085041', fontWeight:500 }}>🟢 Historial real</span>}
          </div>
        ...
        <div style={{ padding:'24px 28px' }}>
          ...
          {!cargando && (
            <>
              ...
              {hayRiesgo ? (
                <div style={{ background:'#FAEEDA', border:'1px solid #EF9F27', borderRadius:10, padding:'10px 16px', marginBottom:16, fontSize:13, color:'#633806' }}>
                  ⚠️ En escenario pesimista la caja baja de {fmtM(minCaja)}. Considera una línea de crédito preventiva.
                </div>
              ) : (
                <div style={{ background:'#EAF3DE', border:'1px solid #97C459', borderRadius:10, padding:'10px 16px', marginBottom:16, fontSize:13, color:'#27500A' }}>
              ...
              {tab==='grafico' && (
                <>
                  ...
                  <div style={{ background:'#fff', border:'1px solid rgba(0,0,0,0.08)', borderRadius:14, padding:20, marginBottom:16 }}>
                    <div style={{ fontSize:12, fontWeight:600, color:'#6b7280', textTransform:'uppercase', letterSpacing:'0.06em', marginBottom:14 }}>Flujo neto mensual proyectado</div>
                    ...
                    <table style={{ width:'100%', borderCollapse:'collapse', fontSize:12, minWidth:600 }}>
                      <thead>
                        <tr style={{ background:'#fafafa' }}>
                          <th style={{ textAlign:'left', padding:'9px 12px', fontWeight:500, color:'#6b7280', borderBottom:'1px solid rgba(0,0,0,0.07)', whiteSpace:'nowrap' as const }}>Concepto</th>
                          {mesesFuturos.map(m=><th key={m} style={{ textAlign:'right', padding:'9px 8px', fontWeight:500, color:'#6b7280', borderBottom:'1px solid rgba(0,0,0,0.07)', whiteSpace:'nowrap' as const }}>{m.slice(0,6)}</th>)}
                        </tr>
                      </thead>
                      <tbody>
                        {[
              ...
              <div style={{ background:'#fff', border:'1px solid rgba(0,0,0,0.08)', borderRadius:14, padding:20, marginTop:16 }}>
                <div style={{ fontSize:12, fontWeight:600, color:'#6b7280', textTransform:'uppercase', letterSpacing:'0.06em', marginBottom:14 }}>Historial real — base de la proyección</div>
